...
const iconGuide = "/icons/icon-guide.svg";
const iconTips = "/icons/icon-tips.svg";
const iconPromptGen = "/icons/icon-prompt-generator.svg";
      ...
      <div className="flex-1 flex min-h-0">
        <div className="flex-1 flex flex-col min-w-0">
          ...
          {previewItem ? (
            ...
            <>
              <div className="flex-1 overflow-hidden px-3 lg:px-6 pb-1 lg:pb-4 flex items-center justify-center">
                {generating ? (
