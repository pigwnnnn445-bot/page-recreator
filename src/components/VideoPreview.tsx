  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 px-3 md:px-6 py-2 md:py-4 overflow-hidden">
      ...
      <div className="flex justify-start pt-3 md:pt-4 pb-1">
        <button onClick={handleDownload} className="flex items-center justify-center gap-2 w-full md:w-auto px-12 py-3 rounded-full bg-primary dark:bg-[hsl(240,74%,61%)] text-primary-foreground text-base font-medium hover:opacity-90 transition-opacity cursor-pointer">
